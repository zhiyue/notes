...
*** boost::property_tree
http://www.boost.org/doc/libs/1_58_0/doc/html/property_tree.html 用作配置文件不错

*** boost::python
http://www.boost.org/doc/libs/1_58_0/libs/python/doc/index.html 编写Python Extension
