...
** Algorithm Related
   ...
   - [[file:data-mining.org][Data Mining]] / [[file:./machine-learning.org][Machine Learning]] 数据挖掘和机器学习
     - [[file:ml-class.org][notes on "Machine Learning by Andrew Ng on Coursera"]] 笔记和一些习题答案代码(仅供学习)
...
** Storage System
   ...
   - [[file:./galera.org][Galera]] 基于MySQL的同步多主备份集群(synchronous multi-master replication cluster). [[file:galerac.org][代码分析]]
     - [[file:./gcomm.org][gcomm]] group communication system
...
** Software Design
   ...
   - [[file:./programmer-career.org][程序员职业规划]] (摘自各方观点)
