...
** Storage System
   ...
   - [[file:./galera.org][Galera]] 基于MySQL的同步多主备份集群(synchronous multi-master replication cluster). [[file:galerac.org][代码分析]]
     - [[file:./gcomm.org][gcomm]] galera communication system
     - [[file:./gcs.org][gcs]]   group communication system
     - [[file:./replicator.org][replicator]] galera replicator system
...
Here is my contact info. I think email is the easiest way to get me.
   ...
   - talks
     ...
     - [[file:./images/SACC2014.pdf][如何在一天之内收集3.6亿移动设备的数据]]
